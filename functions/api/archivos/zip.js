...
// R2 no genera zips server-side por sí solo, así que lo armamos acá con
// fflate (rápido y sin dependencias nativas, corre bien en el Worker).
export async function onRequestPost({ request, env }) {
  ...
  try {
    ...
    const zipBytes = zipSync(archivosZip, { level: 6 });
